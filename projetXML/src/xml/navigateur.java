...
public class navigateur extends JPanel implements MouseListener {
	...
	private static JMenuItem choix7 = new JMenuItem("Ajouter attribut");
	...
	{		
		...
		choix7.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				JOptionPane jop = new JOptionPane();
				JOptionPane jop2 = new JOptionPane();
			    String nom = jop.showInputDialog(null, "Veuillez saisir le nom du nouvel attribut", JOptionPane.QUESTION_MESSAGE);
			    String nom2 = jop2.showInputDialog(null, "Veuillez saisir la valeur du nouvel attribut", JOptionPane.QUESTION_MESSAGE);
			   	elementAModif();
				
				amodif.setAttribute(nom,nom2);
				refreshAll();
